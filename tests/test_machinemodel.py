    ...
    def test_machine_model_update(self):
        ...
        correct = {'kerncraft version': kerncraft_version,
             ...
             'compiler': collections.OrderedDict([
                 ...
                 ('gcc',
                  'INFORMATION_REQUIRED (e.g., -O3 -march=ivybridge, check `gcc -march=native -Q '
             ...
             'micro-architecture': 'INFORMATION_REQUIRED (e.g. NHM, WSM, SNB, IVB, HSW, BDW, SKL, SKX)',
             'model name': 'Intel(R) Xeon(R) CPU E5-2660 v2 @ 2.20GHz',
             'model type': 'Intel Xeon IvyBridge EN/EP/EX processor',
             'non-overlapping model': {'performance counter metric': 'INFORMATION_REQUIRED '
                                       ...
                                       'ports': 'INFORMATION_REQUIRED (list of ports as they appear in IACA, '
                                                'e.g.), ["0", "0DV", "1", "2", "2D", "3", "3D", "4", "5", "6", '
                                                '"7"])'},
             'overlapping model': {'performance counter metric': 'INFORMATION_REQUIRED '
                                                                 'Example:max(UOPS_DISPATCHED_PORT_PORT_0__PMC2, '
                                                                 'UOPS_DISPATCHED_PORT_PORT_1__PMC3,    '
                                                                 'UOPS_DISPATCHED_PORT_PORT_4__PMC0, '
                                                                 'UOPS_DISPATCHED_PORT_PORT_5__PMC1)',
